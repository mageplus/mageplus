...
$installer->getConnection()->modifyColumn($installer->getTable('salesrule/coupon'), 'created_at', array(
    'type' => Varien_Db_Ddl_Table::TYPE_TIMESTAMP,
    'nullable' => true,
    'default' => '0000-00-00 00:00:00',
    'comment' => 'Coupon Code Creation Time'
), true);

// add trigger on create
$installer->getConnection()
    ->addTrigger($installer->getTable('salesrule/coupon'), 'trig_' . $installer->getTable('salesrule/coupon') . '_created',
